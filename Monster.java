...
class Goblin extends Monster {
	public Goblin() {
		super("고블린", 80, 30, 20, 20, 20);
	}
}
// 일반 3
class Golem extends Monster {
	public Golem() {
		super("골렘", 100, 50, 30, 30, 30);
	}
}
//일반 4
class Spider extends Monster {
	public Spider() {
		super("스파이더", 120, 60, 40, 40, 40);
	}
}
//일반 5
class Centaurus extends Monster {
	public Centaurus() {
		super("캔타우로스", 140, 70, 50, 50, 50);
	}
}
//일반 6
class Ghoul extends Monster {
	public Ghoul() {
		super("구울", 160, 80, 60, 60, 60);
	}
}
//일반 7
class Necrosyl extends Monster {
	public Necrosyl() {
		super("네크로실", 180, 100, 70, 70, 70);
	}
}
//일반 8
class Abyssmaster extends Monster {
	public Abyssmaster() {
		super("어비스마스터", 200, 110, 80, 80, 80);
	}
}
//일반 9
class Bloodraven extends Monster {
	public Bloodraven() {
		super("블러드레이븐", 220, 120, 90, 90, 90);
	}
}
//일반 10 
class Darkcyclone extends Monster {
	public Darkcyclone() {
		super("다크사이클론", 250, 130, 100, 100, 100);
	}
}
...
class Dragon extends Monster {
	public Dragon() {
		super("철갑 드래곤", 500, 150, 100, 1000, 200);
	}
}
//보스 2
class KingofDemon extends Monster {
	public KingofDemon() {
		super("불멸의 악마왕", 750, 175, 200, 1500, 300);
	}
}
//보스 3
class DeadLord extends Monster {
	public DeadLord() {
		super("죽음의 그림자 군주", 1000, 200, 300, 2000, 400);
	}
}
